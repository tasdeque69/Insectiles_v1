...
# 7.分工划分 (DIVISION OF LABOR)

## 7.1 Cline (Visual/Frontend) - 视觉/前端

### 负责范围:
- Three.js/WebGL 渲染引擎
- 粒子系统
- 着色器效果 (bloom, chromatic aberration, distortion)
- UI/UX 设计
- 响应式设计 (移动端适配)
- 动画和过渡效果
- 美术资源管线
...
1. 设置 Three.js 环境
2. 实现 Bloom 后处理
3. 实现 Chromatic Aberration 着色器
4. 构建 GPU 粒子系统
5. 创建动态背景着色器
6. 重构昆虫渲染 (从 emoji 到 sprites)
7. Fever Mode 视觉升级
8. 相机震动效果
9. 动态车道颜色
10. 移动端优化

## 7.2 OpenCode (Backend) - 后端
